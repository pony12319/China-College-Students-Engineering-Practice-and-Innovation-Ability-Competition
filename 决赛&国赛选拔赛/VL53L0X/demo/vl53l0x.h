...
#define VL53L0X_Xshut0 PFout(2)
#define VL53L0X_Xshut1 PFout(3)
#define VL53L0X_Xshut2 PFout(4)
#define VL53L0X_Xshut3 PFout(5)
...
VL53L0X_Error vl53l0x_init();//初始化vl53l0x
