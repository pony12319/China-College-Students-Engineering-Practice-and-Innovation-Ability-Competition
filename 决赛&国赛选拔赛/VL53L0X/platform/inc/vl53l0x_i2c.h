...
//IO方向设置
#define VL_SDA_IN()   {GPIOF->CRL&=0XFFFFFF0F;GPIOF->CRL|=8<<4;}
#define VL_SDA_OUT()  {GPIOF->CRL&=0XFFFFFF0F;GPIOF->CRL|=3<<4;}


//IO操作函数	 
#define VL_IIC_SCL    PFout(0)      //SCL
#define VL_IIC_SDA    PFout(1) 		//SDA	 
#define VL_READ_SDA   PFin(1) 		//输入SDA 
